...
auth.post("/signup", async (req, res) => {
  ...
  try {
    ...
    console.log("@@@@@@@@@@@@@")
    const mailOptions = {
      from: "std@panda.knowledger.guru",
      to: email,
      subject: "Welcome to YouTube Clone!",
      html: `
        <div style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;">
          <h1 style="color: #333;">Welcome to YouTube Clone!</h1>
          ...
          <p style="color: #555;">Telahon, David, Sveta</p>
        </div>
      `,
    };
console.log("@@@@@@@@@@@@@")
    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;">
          ...
          <p style="color: #888;">Best regards,<br/>Telahon, David, Sveta</p>
        </div>
      `,
    };
